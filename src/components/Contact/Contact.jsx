      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__options--item">
            ...
            <a href="tel:+380719017755">Call</a>
          </article>
          <article className="contact__options--item">
            <AiOutlineMail />
            <h4>Email</h4>
            <h5>dr.volvakov@gmail.com</h5>
            <a href="mailto:dr.volvakov@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className="contact__options--item">
            <AiOutlineWhatsApp />
            <h4>WhatsApp</h4>
            <h5>+38-071-901-77-55</h5>
            <a href="https://wa.me/+380719017755?text=urlencodedtext" target="_blank">Send a message</a>
          </article>
          <article className="contact__options--item">
            <FaViber />
            <h4>Viber</h4>
            <h5>+38-050-901-77-55</h5>
            <a href="https://msng.link/o/?380719017755=vi" target="_blank">Send a message</a>
          </article>
          <article className="contact__options--item">
            <FaTelegramPlane />
            <h4>Telegram</h4>
            <h5>+38-050-901-77-55</h5>
            <a href="https://t.me/VolodymyrVolvakov" target="_blank">Send a message</a>
          </article>
        </div>
        <form>
